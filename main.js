...
function createMap(){
    ...
    var apitoken = 'pk.eyJ1IjoiYWRkaWVoZWRnZXMiLCJhIjoiY2xhNGo5YjZhMHduMTNvbW53NXJ4eXJ4MSJ9.PaK09aweJ9EyYa1GZ7BiHw' //Enter your API Token - go to 'https://www.mapbox.com/install/' to yours */
    ...
    var outdoorsVariant = L.tileLayer(mbStyleUrl, {id: 'addiehedges/cla4jcuyq000x15t3n6p3i6z4', token: apitoken,  attribution: mbAttr});
    ...
    var map = L.map('map', {
        ...
        zoom: 6, //zoom level
        layers:outdoorsVariant //default base
    });
    ...
    var baseLayers = {
        ...
        "Grayscale": grayscale,
		"Darkscale": dark,
        "Outdoors Variant": outdoorsVariant
    };
